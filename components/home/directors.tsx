...
export function Directors() {
  return (
    <section className="mx-auto  container max-w-7xl bg-secondary/5 px-6 py-20 md:px-12">
...
>
  <div className="aspect-[4/3] overflow-hidden rounded-3xl border-2 border-secondary/50 shadow-2xl">
    <Image
  ...
  <div className="mt-8 max-w-3xl text-left md:mx-auto md:text-center">
